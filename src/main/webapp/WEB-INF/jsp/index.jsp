...
<body>
		...
		<div class="span24">
			...
			<img src="${pageContext.request.contextPath}/image/a.jpg" width="260" height="343" alt="热门商品" title="热门商品">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach items="${hotproducts }" var="hd">
						<li><a
							href="${pageContext.request.contextPath}/product_findByPid.action?pid=${hd.pid}"
							target="_blank"><img
								src="${pageContext.request.contextPath}/${hd.image}"
			...
			<div id="newProduct" class="newProduct clearfix">
				...
				<ul class="tabContent" style="display: block;">
					<c:forEach items="${newproducts }" var="np">
						<li><a
							href="${pageContext.request.contextPath}/product_findByPid.action?pid=${np.pid}"
							target="_blank"><img
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2009-2027网上商城 版权所有</div>
		</div>
	</div>
</body>
</html>